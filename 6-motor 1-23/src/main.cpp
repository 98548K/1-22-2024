...
void autonomous(void) {
 ...
 if (auton == 1) {
  ...
  Drivetrain.driveFor(forward, 7.5, inches);
  Drivetrain.turnFor(left, 61.5, degrees);
  piston.set(false);
...
Drivetrain.driveFor(forward,10,inches);*/
  ...
  if (auton == 2) {
   ...
   Drivetrain.turnFor(right,175,degrees);
   piston_2.set(true);
   piston.set(true);
   ...
   Drivetrain.driveFor(reverse,75,inches);
  ...
  Drivetrain.driveFor(forward,41.5,inches);
  Drivetrain.turnFor(right,67,degrees);
  Drivetrain.setDriveVelocity(50,percent);
  Drivetrain.driveFor(forward,60,inches,false);
  Intake.spinFor(-635,degrees);
